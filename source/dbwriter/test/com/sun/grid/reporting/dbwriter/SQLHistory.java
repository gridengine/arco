...
import com.sun.grid.reporting.dbwriter.ReportingDBWriter.DerivedValueThread;
...
public class SQLHistory implements DatabaseListener, CommitListener {
   ...
   /**
    * is invoked if a statement has produced an error
    * @param statement  the statement
    ...
    */
   public boolean waitForSqlStatementAndClear(String stmt, long timeout,
         SQLException[] error) throws InterruptedException {
    ...
    * @return true of the statement has been found in the cache
    */
   public boolean waitForSqlPatternAndClear(String pat, long timeout,
         SQLException[] error) throws InterruptedException {
    ...
    * @return true of the statement has been found in the cache
    */
   public boolean waitForSqlPatternsAndClear(String[] patterns, long timeout,
         SQLException[] error) throws InterruptedException {
      return  processPatterns(patterns, timeout, error, true);
   }
   
   private boolean processPatterns(String[] patterns, long timeout,
         SQLException[] error,boolean expr) throws InterruptedException {
   ...
   private boolean processPatternList(List patternList, long timeout,
         SQLException[] error, boolean expr) throws InterruptedException {
