...
public class ReportingUserValueManager extends ReportingValueManager {
   ...
   public ReportingUserValueManager(Database p_database)
      throws ReportingException {
      super(p_database, "sge_user_values", "uv_", true,
      new ReportingUserValue(null));
   }
   ...
   public void storeNewValue(DatabaseObject parent, DatabaseField time, String variable, String value, String config,
      ...
      try {
         ...
         ReportingException ex = new ReportingException( "ReportingUserValueManager.createDBObjectError", exception.getMessage());
