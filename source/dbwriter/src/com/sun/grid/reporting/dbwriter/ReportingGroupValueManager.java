...
public class ReportingGroupValueManager extends ReportingValueManager {
   /** Creates a new instance of ReportingDepartmentValueManager */
   public ReportingGroupValueManager(Database p_database)
      throws ReportingException {
      super(p_database, "sge_group_values", "gv_", true,
      new ReportingGroupValue(null));
   }
   ...
   public void storeNewValue(DatabaseObject parent, DatabaseField time, String variable, String value, String config,
      ...
      try {
         ...
         ReportingException ex = new ReportingException("ReportingGroupValueManager.createDBObjectError", exception.getMessage());
