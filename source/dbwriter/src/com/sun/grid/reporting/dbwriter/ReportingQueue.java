...
public class ReportingQueue extends DatabaseObject {
   
   /** Creates a new instance of ReportingQueue */
   public ReportingQueue(DatabaseObjectManager p_manager) {
      super(p_manager);
      
      DatabaseField myfields[] = {
         new StringField("q_qname"),
         new StringField("q_hostname")
      };
   ...
   public DatabaseObject newObject(DatabaseObjectManager manager) {
      return new ReportingQueue(manager);
   }
}
