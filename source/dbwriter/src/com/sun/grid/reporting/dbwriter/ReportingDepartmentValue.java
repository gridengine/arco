 ...
 */
public class ReportingDepartmentValue extends DatabaseObject {
 
   /** Creates a new instance of ReportingJob */
   public ReportingDepartmentValue(DatabaseObjectManager p_manager) {
      super(p_manager);
   ...
   public DatabaseObject newObject(DatabaseObjectManager manager) {
      return new ReportingDepartmentValue(manager);
   }
}
