 ...
 */
abstract public class DatabaseField {
   ...
   /** Creates a new instance of DatabaseField
    * @param p_name Name of the new DatabaseField.
    */
   public DatabaseField(String p_name) {
      this(null, p_name);
   }
    ...
    */   
   public DatabaseField(String name, boolean store) {
      this(null,name,store);
   }

   /** Creates a new instance of a DatabaseField.
    * @param  obj   the database object to which this field belongs
    * @param  name  name of the database field
    */
   public DatabaseField(DatabaseObject obj, String name) {
      this(obj, name, true);
   }
    ...
    */
   public DatabaseField(DatabaseObject obj, String name, boolean store) {
      this.obj = obj;
      this.name = name;
      this.store = store;
      setChanged(false);
    ...
    *   @see  com.sun.grid.reporting.dbwriter.DatabaseObject#databaseFieldChanged
    */
   public void setDatabaseObject(DatabaseObject obj) {
      this.obj = obj;
   }
   ...
   /** Returns the name of the DatabaseField.
   ...
   /** Shall the DatabaseField be stored?
    ...
    *  @see com.sun.grid.reporting.dbwriter.db.DatabaseObject#databaseFieldChanged
    */
    ...
    * The input string has to be parsed to the datatype of the DatabaseField.
   ...
   /** Set a new value by copying from another DatabaseField.
    * Prerequisit for this operation is, that the DatabaseFields are either of the same
    * class or appropriate casting code for other DatabaseField derived classes are
    * provided.
    * @param newValue A DatabaseField containing the new value to set.
    */   
   abstract public void setValue(DatabaseField newValue);
   /** Return the value of the DatabaseField in a string representation.
   ...
   protected double parseDouble(String value) throws NumberFormatException {
      if( value == null || value.length() == 0 ) {
         ...
         SGELog.severe("DatabaseField.hasInvalidValue", getName(), value );
         return 0.0;
