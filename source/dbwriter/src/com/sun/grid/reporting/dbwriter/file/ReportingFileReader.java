...
public class ReportingFileReader extends ReportFileReader {
   ...
   public ReportingFileReader(String p_fileName, String p_delimiter) {
      ...
      accountingFields = new DatabaseField[] {
         new DateField("time"),
      ...
      hostConsumableFields = new DatabaseField[] {
         new DateField("time"),
         new StringField("type"),
      ...
      queueConsumableFields = new DatabaseField[] {
         new DateField("time"),
         new StringField("type"),
      ...
      sharelogFields = new DatabaseField[] {
         new DateField("time"),
         new StringField("type"),
      ...
      newjobFields = new DatabaseField[] {
         new DateField("time"),
         new StringField("type"),
      ...
      joblogFields = new DatabaseField[] {
         new DateField("time"),
         new StringField("type"),
