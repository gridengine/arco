...
public class ReportingShareLog extends DatabaseObject {
 
   /** Creates a new instance of ReportingShareLog */
   public ReportingShareLog(DatabaseObjectManager p_manager) {
      super(p_manager);
   ...
   public DatabaseObject newObject(DatabaseObjectManager manager) {
      return new ReportingShareLog(manager);
   }
}
