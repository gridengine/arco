...
public class DatabaseStoredObjectManager extends DatabaseObjectManager {
   ...
   public DatabaseStoredObjectManager(Database p_database, String p_table,
   String p_prefix, boolean hasParent, String p_primaryKey[],
   DatabaseObject p_template, String p_condition) throws ReportingException {
      super(p_database, p_table, p_prefix, hasParent, p_template);
      condition = p_condition;
      primaryKeyFields = p_primaryKey;
      storedObjects = new DatabaseObjectCache(this);
   }
   ...
   public DatabaseObject getObject(PrimaryKey pk, java.sql.Connection connection ) throws ReportingException {
      return storedObjects.getObject( pk, connection );
   }
