...
public class ReportingJobUsageManager extends ReportingObjectManager {
   ...
   public ReportingJobUsageManager(Database p_database) throws ReportingException {
      super(p_database, "sge_job_usage", "ju_", true,
      new ReportingJobUsage(null));
   ...
   public void initObjectFromEvent(DatabaseObject jobUsage, ReportingEventObject e) {
      if (e.reportingSource == ReportingSource.ACCOUNTING) {
         initObjectFromEventData(jobUsage, e.data, accountingMap);
      }
   }
}
