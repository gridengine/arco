...
public class RecordExecutor {
   ...
   /**
    * Creates a new instance of RecordExecutor
    */
   public RecordExecutor(Database p_database, String p_table, String p_prefix, 
    ...
    *
    * @see com.sun.grid.reporting.dbwriter.db.RecordCache#readObject
   ...
   public Record newDBRecord() throws InstantiationException, IllegalAccessException {
      return template.newDBRecord(this);
   }
