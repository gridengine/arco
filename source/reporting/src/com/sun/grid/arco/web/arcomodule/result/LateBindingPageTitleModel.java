...
public class LateBindingPageTitleModel extends CCPageTitleModel implements ModelListener {
   ...
   public LateBindingPageTitleModel() {
      ...
      setDocument(Util.getInputStream(LateBindingPageTitleModel.class,"LateBindingPageTitle.xml"));
   ...
   private void updateTitle(  ) {
      ...
      if(queryResult != null) {
         setPageTitleText( "Latebindings for query " + queryResult.getQuery().getName() );
      }
   }
